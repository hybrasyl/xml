...
public partial class ItemMotion
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(ItemMotion));
            }
    ...
    /// <summary>
    /// Deserializes ItemMotion object
    /// </summary>
    ...
    public static ItemMotion Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ItemMotion)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((ItemMotion)(SerializerXml.Deserialize(s)));
    }
    #endregion
