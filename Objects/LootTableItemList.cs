...
public partial class LootTableItemList
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(LootTableItemList));
            }
    ...
    /// <summary>
    /// Serialize LootTableItemList object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes LootTableItemList object
    /// </summary>
    ...
    public static LootTableItemList Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((LootTableItemList)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((LootTableItemList)(SerializerXml.Deserialize(s)));
    }
    #endregion
