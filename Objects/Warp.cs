...
public partial class Warp
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Warp));
            }
    ...
    public static Warp Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Warp)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Warp)(SerializerXml.Deserialize(s)));
    }
    #endregion
