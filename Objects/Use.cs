...
public partial class Use
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Use));
            }
    ...
    public static Use Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Use)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Use)(SerializerXml.Deserialize(s)));
    }
    #endregion
