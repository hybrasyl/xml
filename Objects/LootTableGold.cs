...
public partial class LootTableGold
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(LootTableGold));
            }
    ...
    /// <summary>
    /// Serialize LootTableGold object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes LootTableGold object
    /// </summary>
    ...
    public static LootTableGold Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((LootTableGold)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((LootTableGold)(SerializerXml.Deserialize(s)));
    }
    #endregion
