...
public partial class ItemUseEffect
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(ItemUseEffect));
            }
    ...
    /// <summary>
    /// Serialize ItemUseEffect object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes ItemUseEffect object
    /// </summary>
    ...
    public static ItemUseEffect Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ItemUseEffect)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((ItemUseEffect)(SerializerXml.Deserialize(s)));
    }
    #endregion
