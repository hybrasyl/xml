...
public partial class CastableDamage
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(CastableDamage));
            }
    ...
    /// <summary>
    /// Serialize CastableDamage object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes CastableDamage object
    /// </summary>
    ...
    public static CastableDamage Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((CastableDamage)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((CastableDamage)(SerializerXml.Deserialize(s)));
    }
    #endregion
