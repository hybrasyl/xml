...
public partial class LearnPrerequisite
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(LearnPrerequisite));
            }
    ...
    /// <summary>
    /// Serialize LearnPrerequisite object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes LearnPrerequisite object
    /// </summary>
    ...
    public static LearnPrerequisite Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((LearnPrerequisite)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((LearnPrerequisite)(SerializerXml.Deserialize(s)));
    }
    #endregion
