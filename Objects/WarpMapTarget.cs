...
public partial class WarpMapTarget
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(WarpMapTarget));
            }
    ...
    /// <summary>
    /// Serialize WarpMapTarget object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes WarpMapTarget object
    /// </summary>
    ...
    public static WarpMapTarget Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((WarpMapTarget)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((WarpMapTarget)(SerializerXml.Deserialize(s)));
    }
    #endregion
