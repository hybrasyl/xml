...
public partial class Stackable
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Stackable));
            }
    ...
    public static Stackable Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Stackable)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Stackable)(SerializerXml.Deserialize(s)));
    }
    #endregion
