...
public partial class LootSet
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(LootSet));
            }
    ...
    public static LootSet Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((LootSet)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((LootSet)(SerializerXml.Deserialize(s)));
    }
    #endregion
