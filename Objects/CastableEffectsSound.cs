...
public partial class CastableEffectsSound
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(CastableEffectsSound));
            }
    ...
    /// <summary>
    /// Serialize CastableEffectsSound object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes CastableEffectsSound object
    /// </summary>
    ...
    public static CastableEffectsSound Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((CastableEffectsSound)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((CastableEffectsSound)(SerializerXml.Deserialize(s)));
    }
    #endregion
