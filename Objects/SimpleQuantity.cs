...
public partial class SimpleQuantity
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(SimpleQuantity));
            }
    ...
    /// <summary>
    /// Serialize SimpleQuantity object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes SimpleQuantity object
    /// </summary>
    ...
    public static SimpleQuantity Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((SimpleQuantity)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((SimpleQuantity)(SerializerXml.Deserialize(s)));
    }
    #endregion
