...
public partial class Chat
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Chat));
            }
    ...
    public static Chat Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Chat)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Chat)(SerializerXml.Deserialize(s)));
    }
    #endregion
