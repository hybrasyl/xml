...
public partial class Item
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Item));
            }
    ...
    public static Item Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Item)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Item)(SerializerXml.Deserialize(s)));
    }
    #endregion
