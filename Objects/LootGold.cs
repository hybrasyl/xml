...
public partial class LootGold
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(LootGold));
            }
    ...
    public static LootGold Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((LootGold)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((LootGold)(SerializerXml.Deserialize(s)));
    }
    #endregion
