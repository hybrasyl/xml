...
public partial class Category
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Category));
            }
    ...
    public static Category Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Category)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Category)(SerializerXml.Deserialize(s)));
    }
    #endregion
