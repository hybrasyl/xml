...
public partial class WarpRestrictions
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(WarpRestrictions));
            }
    ...
    /// <summary>
    /// Serialize WarpRestrictions object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes WarpRestrictions object
    /// </summary>
    ...
    public static WarpRestrictions Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((WarpRestrictions)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((WarpRestrictions)(SerializerXml.Deserialize(s)));
    }
    #endregion
