...
public partial class Requirement : ClassRequirement
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Requirement));
            }
    ...
    /// <summary>
    /// Deserializes Requirement object
    /// </summary>
    ...
    public new static Requirement Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Requirement)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Requirement)(SerializerXml.Deserialize(s)));
    }
    #endregion
