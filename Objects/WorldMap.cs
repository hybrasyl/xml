...
public partial class WorldMap
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(WorldMap));
            }
    ...
    public static WorldMap Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((WorldMap)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((WorldMap)(SerializerXml.Deserialize(s)));
    }
    #endregion
