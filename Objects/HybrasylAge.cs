...
public partial class HybrasylAge
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(HybrasylAge));
            }
    ...
    /// <summary>
    /// Deserializes HybrasylAge object
    /// </summary>
    ...
    public static HybrasylAge Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((HybrasylAge)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((HybrasylAge)(SerializerXml.Deserialize(s)));
    }
    #endregion
