...
public partial class Conditions
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Conditions));
            }
    ...
    /// <summary>
    /// Deserializes Conditions object
    /// </summary>
    ...
    public static Conditions Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Conditions)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Conditions)(SerializerXml.Deserialize(s)));
    }
    #endregion
