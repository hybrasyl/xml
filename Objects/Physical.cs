...
public partial class Physical
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Physical));
            }
    ...
    public static Physical Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Physical)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Physical)(SerializerXml.Deserialize(s)));
    }
    #endregion
