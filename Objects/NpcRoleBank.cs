...
public partial class NpcRoleBank
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(NpcRoleBank));
            }
    ...
    /// <summary>
    /// Deserializes NpcRoleBank object
    /// </summary>
    ...
    public static NpcRoleBank Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((NpcRoleBank)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((NpcRoleBank)(SerializerXml.Deserialize(s)));
    }
    #endregion
