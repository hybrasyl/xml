...
public partial class Death
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Death));
            }
    ...
    public static Death Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Death)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Death)(SerializerXml.Deserialize(s)));
    }
    #endregion
