...
public partial class NationMap
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(NationMap));
            }
    ...
    public static NationMap Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((NationMap)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((NationMap)(SerializerXml.Deserialize(s)));
    }
    #endregion
