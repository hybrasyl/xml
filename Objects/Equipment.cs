...
public partial class Equipment
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Equipment));
            }
    ...
    public static Equipment Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Equipment)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Equipment)(SerializerXml.Deserialize(s)));
    }
    #endregion
