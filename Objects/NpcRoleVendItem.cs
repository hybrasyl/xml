...
public partial class NpcRoleVendItem
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(NpcRoleVendItem));
            }
    ...
    /// <summary>
    /// Serialize NpcRoleVendItem object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes NpcRoleVendItem object
    /// </summary>
    ...
    public static NpcRoleVendItem Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((NpcRoleVendItem)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((NpcRoleVendItem)(SerializerXml.Deserialize(s)));
    }
    #endregion
