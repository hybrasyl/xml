...
public partial class WorldMapPoints
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(WorldMapPoints));
            }
    ...
    /// <summary>
    /// Serialize WorldMapPoints object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes WorldMapPoints object
    /// </summary>
    ...
    public static WorldMapPoints Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((WorldMapPoints)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((WorldMapPoints)(SerializerXml.Deserialize(s)));
    }
    #endregion
