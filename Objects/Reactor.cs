...
public partial class Reactor
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Reactor));
            }
    ...
    public static Reactor Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Reactor)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Reactor)(SerializerXml.Deserialize(s)));
    }
    #endregion
