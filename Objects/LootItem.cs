...
public partial class LootItem
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(LootItem));
            }
    ...
    public static LootItem Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((LootItem)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((LootItem)(SerializerXml.Deserialize(s)));
    }
    #endregion
