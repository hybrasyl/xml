...
public partial class CastCost : ClassCastCost
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(CastCost));
            }
    ...
    public new static CastCost Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((CastCost)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((CastCost)(SerializerXml.Deserialize(s)));
    }
    #endregion
