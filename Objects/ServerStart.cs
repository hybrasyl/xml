...
public partial class ServerStart
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(ServerStart));
            }
    ...
    /// <summary>
    /// Deserializes ServerStart object
    /// </summary>
    ...
    public static ServerStart Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ServerStart)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((ServerStart)(SerializerXml.Deserialize(s)));
    }
    #endregion
