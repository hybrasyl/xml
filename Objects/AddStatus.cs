...
public partial class AddStatus
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(AddStatus));
            }
    ...
    public static AddStatus Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((AddStatus)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((AddStatus)(SerializerXml.Deserialize(s)));
    }
    #endregion
