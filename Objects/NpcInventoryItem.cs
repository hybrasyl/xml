...
public partial class NpcInventoryItem
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(NpcInventoryItem));
            }
    ...
    /// <summary>
    /// Serialize NpcInventoryItem object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes NpcInventoryItem object
    /// </summary>
    ...
    public static NpcInventoryItem Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((NpcInventoryItem)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((NpcInventoryItem)(SerializerXml.Deserialize(s)));
    }
    #endregion
