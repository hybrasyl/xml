...
public partial class NpcRolePost
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(NpcRolePost));
            }
    ...
    /// <summary>
    /// Deserializes NpcRolePost object
    /// </summary>
    ...
    public static NpcRolePost Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((NpcRolePost)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((NpcRolePost)(SerializerXml.Deserialize(s)));
    }
    #endregion
