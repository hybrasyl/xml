...
public partial class ItemDamage
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(ItemDamage));
            }
    ...
    /// <summary>
    /// Deserializes ItemDamage object
    /// </summary>
    ...
    public static ItemDamage Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ItemDamage)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((ItemDamage)(SerializerXml.Deserialize(s)));
    }
    #endregion
