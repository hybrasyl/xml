...
public partial class StatusDamage
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(StatusDamage));
            }
    ...
    /// <summary>
    /// Deserializes StatusDamage object
    /// </summary>
    ...
    public static StatusDamage Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((StatusDamage)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((StatusDamage)(SerializerXml.Deserialize(s)));
    }
    #endregion
