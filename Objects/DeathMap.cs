...
public partial class DeathMap
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(DeathMap));
            }
    ...
    public static DeathMap Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((DeathMap)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((DeathMap)(SerializerXml.Deserialize(s)));
    }
    #endregion
