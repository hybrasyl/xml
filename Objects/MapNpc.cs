...
public partial class MapNpc
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(MapNpc));
            }
    ...
    public static MapNpc Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((MapNpc)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((MapNpc)(SerializerXml.Deserialize(s)));
    }
    #endregion
