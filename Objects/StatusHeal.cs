...
public partial class StatusHeal
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(StatusHeal));
            }
    ...
    /// <summary>
    /// Deserializes StatusHeal object
    /// </summary>
    ...
    public static StatusHeal Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((StatusHeal)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((StatusHeal)(SerializerXml.Deserialize(s)));
    }
    #endregion
