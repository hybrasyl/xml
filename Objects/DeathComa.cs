...
public partial class DeathComa
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(DeathComa));
            }
    ...
    public static DeathComa Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((DeathComa)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((DeathComa)(SerializerXml.Deserialize(s)));
    }
    #endregion
