...
public partial class ItemUseSound
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(ItemUseSound));
            }
    ...
    /// <summary>
    /// Deserializes ItemUseSound object
    /// </summary>
    ...
    public static ItemUseSound Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ItemUseSound)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((ItemUseSound)(SerializerXml.Deserialize(s)));
    }
    #endregion
