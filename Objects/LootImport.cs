...
public partial class LootImport
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(LootImport));
            }
    ...
    /// <summary>
    /// Deserializes LootImport object
    /// </summary>
    ...
    public static LootImport Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((LootImport)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((LootImport)(SerializerXml.Deserialize(s)));
    }
    #endregion
