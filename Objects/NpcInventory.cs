...
public partial class NpcInventory
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(NpcInventory));
            }
    ...
    /// <summary>
    /// Deserializes NpcInventory object
    /// </summary>
    ...
    public static NpcInventory Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((NpcInventory)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((NpcInventory)(SerializerXml.Deserialize(s)));
    }
    #endregion
