...
public partial class GlobalBoard
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(GlobalBoard));
            }
    ...
    /// <summary>
    /// Deserializes GlobalBoard object
    /// </summary>
    ...
    public static GlobalBoard Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((GlobalBoard)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((GlobalBoard)(SerializerXml.Deserialize(s)));
    }
    #endregion
