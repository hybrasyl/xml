...
public partial class NpcRoleRepair
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(NpcRoleRepair));
            }
    ...
    /// <summary>
    /// Serialize NpcRoleRepair object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes NpcRoleRepair object
    /// </summary>
    ...
    public static NpcRoleRepair Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((NpcRoleRepair)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((NpcRoleRepair)(SerializerXml.Deserialize(s)));
    }
    #endregion
