...
public partial class NpcAppearance
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(NpcAppearance));
            }
    ...
    /// <summary>
    /// Serialize NpcAppearance object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes NpcAppearance object
    /// </summary>
    ...
    public static NpcAppearance Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((NpcAppearance)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((NpcAppearance)(SerializerXml.Deserialize(s)));
    }
    #endregion
