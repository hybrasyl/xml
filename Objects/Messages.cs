...
public partial class Messages
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Messages));
            }
    ...
    public static Messages Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Messages)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Messages)(SerializerXml.Deserialize(s)));
    }
    #endregion
