...
public partial class Description
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Description));
            }
    ...
    public static Description Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Description)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Description)(SerializerXml.Deserialize(s)));
    }
    #endregion
