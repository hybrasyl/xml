...
public partial class Castable
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Castable));
            }
    ...
    public static Castable Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Castable)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Castable)(SerializerXml.Deserialize(s)));
    }
    #endregion
