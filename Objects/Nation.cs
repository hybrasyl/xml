...
public partial class Nation
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Nation));
            }
    ...
    public static Nation Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Nation)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Nation)(SerializerXml.Deserialize(s)));
    }
    #endregion
