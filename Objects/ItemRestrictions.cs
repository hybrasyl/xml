...
public partial class ItemRestrictions
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(ItemRestrictions));
            }
    ...
    /// <summary>
    /// Serialize ItemRestrictions object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes ItemRestrictions object
    /// </summary>
    ...
    public static ItemRestrictions Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ItemRestrictions)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((ItemRestrictions)(SerializerXml.Deserialize(s)));
    }
    #endregion
