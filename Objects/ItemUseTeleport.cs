...
public partial class ItemUseTeleport
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(ItemUseTeleport));
            }
    ...
    /// <summary>
    /// Serialize ItemUseTeleport object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes ItemUseTeleport object
    /// </summary>
    ...
    public static ItemUseTeleport Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((ItemUseTeleport)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((ItemUseTeleport)(SerializerXml.Deserialize(s)));
    }
    #endregion
