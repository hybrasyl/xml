...
public partial class Variants
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Variants));
            }
    ...
    public static Variants Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Variants)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Variants)(SerializerXml.Deserialize(s)));
    }
    #endregion
