...
public partial class GlobalBoardAccessList
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(GlobalBoardAccessList));
            }
    ...
    /// <summary>
    /// Serialize GlobalBoardAccessList object
    /// </summary>
    ...
    /// <summary>
    /// Deserializes GlobalBoardAccessList object
    /// </summary>
    ...
    public static GlobalBoardAccessList Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((GlobalBoardAccessList)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((GlobalBoardAccessList)(SerializerXml.Deserialize(s)));
    }
    #endregion
