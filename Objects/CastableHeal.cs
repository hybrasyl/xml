...
public partial class CastableHeal
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(CastableHeal));
            }
    ...
    /// <summary>
    /// Deserializes CastableHeal object
    /// </summary>
    ...
    public static CastableHeal Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((CastableHeal)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((CastableHeal)(SerializerXml.Deserialize(s)));
    }
    #endregion
