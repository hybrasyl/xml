...
public partial class Variant
{
    ...
    private static XmlSerializer SerializerXml
    {
        get
        {
            ...
            {
                _serializerXml = new XmlSerializerFactory().CreateSerializer(typeof(Variant));
            }
    ...
    public static Variant Deserialize(string input)
    {
        ...
        try
        {
            ...
            return ((Variant)(SerializerXml.Deserialize(XmlReader.Create(stringReader))));
        }
        finally
        {
    ...
    {
        return ((Variant)(SerializerXml.Deserialize(s)));
    }
    #endregion
