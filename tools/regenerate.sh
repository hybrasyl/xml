...
# Enums are shared vocabulary with their own allocation contract, so they live
# in Hybrasyl.Xml.Enums rather than alongside the data model.
python3 tools/namespace-enums.py
